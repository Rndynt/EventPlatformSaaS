  ...
  const quickActions = [
    {
      ...
      icon: Plus,
      onClick: () => window.location.href = `/admin/${user.tenant.slug}/events/create`,
      color: 'bg-blue-500',
    },
    {
      title: 'Manage Events',
      ...
      icon: Calendar,
      onClick: () => window.location.href = `/admin/${user.tenant.slug}`,
      color: 'bg-green-500',
    },
    {
      ...
      icon: BarChart3,
      onClick: () => window.location.href = `/admin/${user.tenant.slug}/analytics`,
      color: 'bg-purple-500',
    },
    {
      title: 'Settings',
      ...
      icon: Settings,
      onClick: () => window.location.href = `/admin/${user.tenant.slug}/settings`,
      color: 'bg-orange-500',
    },
  ];
